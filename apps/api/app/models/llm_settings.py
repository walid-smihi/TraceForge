...
class LLMSettings(Base):
    ...
    ollama_base_url: Mapped[Optional[str]] = mapped_column(
        Text, server_default="http://ollama:11434"
    )
    ollama_model: Mapped[Optional[str]] = mapped_column(String(100), server_default="llama3.1:8b")
    ollama_embed_model: Mapped[Optional[str]] = mapped_column(
        String(100), server_default="nomic-embed-text"
    )
    ...
    mistral_model: Mapped[Optional[str]] = mapped_column(
        String(100), server_default="mistral-small-latest"
    )
